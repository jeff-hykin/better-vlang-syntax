...
- Create a `your_feature.v` file in the `language_examples/` folder. Once it is created, add code to it that demonstrates your feature (more demonstration the better).
...
```json
{
    ...
    "name": "punctuation.separator.attribute.v",
    "patterns": [
        {
...
```json
{
    ...
    "beginCaptures": {
        "0": {
            "name": "punctuation.section.attribute.begin.v"
        }
    },
    "endCaptures": {
        "0": {
            "name": "punctuation.section.attribute.end.v"
        }
    },
    "name": "support.other.attribute.v",
    "patterns": [
        {
